    ...
    <tr>
      <td style="background:#ffffff; padding:28px 30px;">
        ...
        <p style="margin:0 0 16px; font-size:14px; line-height:1.6;">
          Your buy request has been submitted successfully. Your KYC is verified and our team will
          verify your payment next. Once approved, you will receive your policy document.
        </p>
        ...
        <p style="margin:0; font-size:14px; line-height:1.6;">
          If you still need to complete payment, you can do it here:
          <a href="{{ $paymentUrl }}" style="color:#0f62fe;">Complete Payment</a>
        </p>
      </td>
    </tr>
    <tr>
