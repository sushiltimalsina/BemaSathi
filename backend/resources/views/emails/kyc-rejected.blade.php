    ...
    <tr>
      <td style="background:#ffffff; padding:28px 30px;">
        ...
        <p style="margin:0 0 12px; font-size:14px; line-height:1.6;">
          Your KYC submission was rejected. Please review the reason below and resubmit your documents.
        </p>
        @if(!empty($reason))
        ...
        @endif
        <p style="margin:0 0 12px; font-size:14px; line-height:1.6;">
          You can resubmit your KYC here: <a href="{{ $resubmitUrl }}" style="color:#0f62fe;">Resubmit KYC</a>
        </p>
        <p style="margin:0; font-size:14px; line-height:1.6;">If you need help, reply to this email.</p>
      </td>
    </tr>
    <tr>
